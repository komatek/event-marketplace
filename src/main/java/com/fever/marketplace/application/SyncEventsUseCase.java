...
@Service
public class SyncEventsUseCase implements SyncEvents {

    private static final Logger logger = LoggerFactory.getLogger(SyncEventsUseCase.class);
    private final ExternalEventProvider externalProvider;
    private final EventRepository eventRepository;

    public SyncEventsUseCase(ExternalEventProvider externalProvider, EventRepository eventRepository) {
